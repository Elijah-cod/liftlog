...
export const exerciseSeeds: ExerciseSeed[] = [
  {
    ...
    subtitle: "3 working sets · 8-12 reps · smooth press",
    loadType: "weighted",
  ...
  },
  {
    id: "lat-pulldowns",
    name: "Lat Pulldowns",
    subtitle: "3 working sets · 8-12 reps · full stretch",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 10-15 reps · controlled hinge",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 8-12 reps per side · stay upright",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
    perSide: true,
  },
  {
    id: "rkc-plank",
    name: "RKC Plank",
    subtitle: "2 focused sets · 30-60 second holds · hard brace",
    loadType: "timed",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 progression sets · 6-10 reps · drive hard",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 progression sets · 6-10 reps · clean lockout",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 8-12 reps per side · long stride",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
    perSide: true,
  },
  {
    ...
    subtitle: "3 working sets · 10-15 reps · squeeze at top",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 controlled sets · 10-20 reps · pelvis tucked",
    loadType: "bodyweight",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 8-12 reps · upper chest bias",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 10-15 reps · soft elbows",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 10-15 reps per side · pause at hip",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
    perSide: true,
  },
  {
    ...
    subtitle: "3 working sets · 10-15 reps · full stretch",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
  },
  {
    ...
    subtitle: "3 working sets · 8-12 reps per side · slow lower",
    loadType: "weighted",
    mediaPath: "/media/exercise-placeholder.svg",
    perSide: true,
  },
...
export const templateSeeds: TemplateSeed[] = [
  {
    ...
    workoutLabel: "Push, pull and trunk control",
    exercises: [
  ...
  },
  {
    ...
    workoutLabel: "Squat, hinge and trunk stability",
    exercises: [
  ...
  },
  {
    ...
    workoutLabel: "Chest, back and arm detail",
    exercises: [
