...
const exerciseSeeds: ExerciseSeed[] = [
  {
    ...
    loadType: "weighted",
    mediaPath: "/media/flat-dumbbell-press.jpg",
  },
  {
    id: "lat-pulldowns",
    name: "Lat Pulldowns",
    subtitle: "3 sets · 8-12 reps",
    loadType: "weighted",
    mediaPath: "/media/lat-pulldowns.jpg",
  },
  {
    ...
    loadType: "weighted",
    mediaPath: "/media/dumbbell-romanian-deadlift.jpg",
  },
  {
    id: "reverse-lunges",
    ...
    loadType: "weighted",
    mediaPath: "/media/reverse-lunges.jpg",
    perSide: true,
  },
  {
    id: "rkc-plank",
  ...
  },
  {
    ...
    loadType: "weighted",
    mediaPath: "/media/barbell-back-squat.jpg",
  },
  {
    id: "barbell-deadlift",
    ...
    subtitle: "3 sets · 6-10 reps",
    loadType: "weighted",
    mediaPath: "/media/barbell-deadlift.jpg",
  },
  {
    id: "walking-lunges",
    ...
    subtitle: "3 sets · 8-12 reps per side",
    loadType: "weighted",
    mediaPath: "/media/walking-lunges.jpg",
    perSide: true,
  },
  {
    ...
    subtitle: "3 sets · 10-15 reps",
    loadType: "weighted",
    mediaPath: "/media/seated-leg-extensions.jpg",
  },
  {
    id: "reverse-crunches",
    ...
    loadType: "bodyweight",
    mediaPath: "/media/reverse-crunches.jpg",
  },
  {
    ...
    subtitle: "3 sets · 8-12 reps",
    loadType: "weighted",
    mediaPath: "/media/low-incline-dumbbell-press.jpg",
  },
  {
    ...
    subtitle: "3 sets · 10-15 reps",
    loadType: "weighted",
    mediaPath: "/media/seated-mid-chest-cable-fly.jpg",
  },
  {
    ...
    loadType: "weighted",
    mediaPath: "/media/half-kneeling-cable-row.jpg",
    perSide: true,
  },
  {
    ...
    subtitle: "3 sets · 10-15 reps",
    loadType: "weighted",
    mediaPath: "/media/incline-dumbbell-overhead-extensions.jpg",
  },
  {
    ...
    subtitle: "3 sets · 8-12 reps per side",
    loadType: "weighted",
    mediaPath: "/media/dumbbell-preacher-curl.jpg",
    perSide: true,
  },
];
